            ...
            <TableBody>
              {data.detalle.map((detalle) => (
                <TableRow key={detalle.codigoProducto}>
                  ...
                  <TableCell>{detalle.productoDetalle.unidad}</TableCell>
                  <TableCell>{detalle.productoDetalle.descripcion}</TableCell>
                  <TableCell>
                    {detalle.vendidas == -1 ? 0 : detalle.vendidas}
                  </TableCell>
                  <TableCell>{detalle.recibidas}</TableCell>
                  <TableCell>{detalle.devolver}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
