                ...
                <Table sx={{ maxWidth: '200px' }}>
                  <TableBody>
                    <TableRow>
                      ...
                      <MUITableCell>
                        <Typography variant="h6">{`#${data.noDocEntrega}`}</Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      <MUITableCell>
                  ...
                  <Table>
                    <TableBody>
                      <TableRow>
                        ...
                        <MUITableCell>{data.neto}</MUITableCell>
                      </TableRow>
                      <TableRow>
                        <MUITableCell>Bank name:</MUITableCell>
                        <MUITableCell>{data.bruto}</MUITableCell>
                      </TableRow>
                      <TableRow>
                        <MUITableCell>Country:</MUITableCell>
                        <MUITableCell>{data.cliente.ciudad}</MUITableCell>
                      </TableRow>
                      <TableRow>
                        <MUITableCell>IBAN:</MUITableCell>
                        <MUITableCell>{data.cliente.rnc}</MUITableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                </TableContainer>
